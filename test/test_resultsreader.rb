...
class TestResultsReader < Test::Unit::TestCase
  def test_results_reader
    ...
    # from various versions of Splunk, against both Nokogiri and REXML. The
    # test data is all asserted in the big global data structure $tests
    # below this class's definition.

    # If Nokogiri is available, we'll test ResultsReader against both it
